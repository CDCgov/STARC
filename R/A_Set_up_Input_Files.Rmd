...
# Downloading Country Borders Via rgeoboundaries::geoboundaries()
```{r}
# Set directory
...
# Split Poly Function (to make H3 method more doable)
```{r}
...
# Function to Extract inputs (raster, osm shape) 
  * Idealy split up into three functions in future
...
# Run the Download Inputs Function
